...
// Setting $showExceptions to true and using the default error.php will cause
// not only exceptions to be displayed but also the backtrace, which can result
// in security issues such as exposing your MySQL user and password when unable
// to connect. Please set it to false in a production environment.
