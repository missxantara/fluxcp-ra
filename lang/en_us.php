...
return array(	
	...
	'NewPasswordNeedLower'    => sprintf('Your new password must contain at least %d lowercase letter(s).', Flux::config('PasswordMinLower')),
	'NewPasswordNeedNumber'   => sprintf('Your new password must contain at least %d number(s).', Flux::config('PasswordMinNumber')),
	'NewPasswordNeedSymbol'   => sprintf('Your new password must contain at least %d symbol(s).', Flux::config('PasswordMinSymbol')),
