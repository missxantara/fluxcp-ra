...
if (!$sth->execute(array($user, $code)) || !($cpaccount=$sth->fetch())) {
	$this->deny();
}
...
$sth->execute(array($cpaccount->cp_aid));

$loginAthenaGroup->loginServer->unban(null, Flux::message('AccountConfirmUnban'), $cpaccount->cp_aid);
